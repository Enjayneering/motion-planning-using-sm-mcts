import sys
import os
from quick_plot_utilities import *
from data.plot_data_utilities import plot_config_map
...
if __name__ == "__main__":
    ...
    exp_name = "V8_Convergence_Overtaking_alphat"
    #exp_name = "V8_Convergence_Following_alphat"
    path_curr_experiment = path_to_exp_results+'/'+ exp_name
    ...
    for ix_row in range(0,n_rows):
        for ix_col in range(0, 2*n_cols, 2):
            plot_figure(axs[ix_row, ix_col+1], axs[ix_row, ix_col], path_curr_experiment, game_length=i)
            i += 1
    ...
    plt.savefig('/home/enjay/0_thesis/01_MCTS/experiments/00_evaluations/0_plots/'+exp_name+'.png', dpi=200)
