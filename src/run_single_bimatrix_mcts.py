...
# solver specific
from solvers.bimatrix_mcts.bimatrix_mcts import BiMatrixMCTS
from solvers.bimatrix_mcts.utilities.plot_test_utilities import *
from solvers.bimatrix_mcts.utilities.plot_utilities import *
from solvers.bimatrix_mcts.utilities.common_utilities import *
from solvers.bimatrix_mcts.utilities.csv_utilities import *

from solvers.bimatrix_mcts.utilities.run_utilities import *
from solvers.bimatrix_mcts.utilities.environment_utilities import *

from configs_single_bimatrix_mcts import test_bimatrix


def run_test(game_dict):
    GamePlanner = BiMatrixMCTS(Environment(Config(game_dict)), Config(game_dict))
...
def run_experiment(exp_path_level_1, game_config, timestep_sim=None, exp_comment="", input=""):
    ...
    for run_ix in range(game_config.num_sim):
        GamePlanner = BiMatrixMCTS(Environment(game_config), game_config)
        exp_ix = run_ix % 10000
...
if __name__ == "__main__":
    ...
    experiments = test_bimatrix.build_experiments()
