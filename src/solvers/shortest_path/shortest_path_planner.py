...
class ShortestPathPlanner:
    def __init__(self, ix_agent, start_state=None, start_timestep=0):
        self.agent = ix_agent
...
if __name__ == "__main__":
    SPPlanner = ShortestPathPlanner(0, 1)
    trajectories = SPPlanner.get_trajectories(num_trajectories=40, scale_dense=0)
